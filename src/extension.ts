...
export async function activate(context: vscode.ExtensionContext) {
  ...
  let gallery = vscode.commands.registerCommand(
    'vscode-toolkit.gallery',
    async () => {
      try {
        await Gallery.init();
      } catch (error) {
        Notification.show(
          'error',
          'Beaker launcher initialize failed.',
  ...
  let updateApps = vscode.commands.registerCommand(
    'vscode-toolkit.updateApps',
    async () => {
