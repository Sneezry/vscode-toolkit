...
function messager(apps) {
  ...
  container.innerHTML = `<div class="app" onclick="NodeJS.install()" style="--jiggle-delay: ${-Math.random()}s"><img src="installer.png"><div>Installer</div></div>
  <div class="app" onclick="NodeJS.launch('::square')" style="--jiggle-delay: ${-Math.random()}s"><img src="../../square/square.png"><div>Square</div></div>`;

  for (const app of apps) {
    const div = document.createElement('div');
    div.className = 'app';
    div.style.setProperty('--jiggle-delay', -Math.random() + 's');
